...
- **GPU batch ~28-30× CPU-SIMD** at M=256 (n=24: 28.65×, n=28: 30.32×) on AMD Radeon RX 6950 XT / gfx1030 (source: `dev/benchmarks/gf2_algebra_permanent/s5_gpu_crossover-2026-05-15.csv`); the S1g GPU-vs-reference 50× measurement is tracked in `9480f8a6`.
