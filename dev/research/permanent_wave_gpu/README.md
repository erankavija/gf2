...
The candidate list is deliberately complete from the first commit. Add a
candidate implementation only by replacing the stub in its dedicated module
and adding that candidate's HIP and test files. Do not add a second registry or
