...
/-- Trait implementation: [core::iter::range::{core::iter::range::Step for u128}]
...
/-- [gf2_algebra::gray::gray_code_iter::{core::ops::function::FnMut<(u128), (usize, i8)> for gf2_algebra::gray::gray_code_iter::closure}::call_mut]:
...
/-- [gf2_algebra::gray::gray_code_iter::{core::ops::function::FnOnce<(u128), (usize, i8)> for gf2_algebra::gray::gray_code_iter::closure}::call_once]:
    Source: 'crates/gf2-algebra/src/gray.rs', lines 139:23-148:5 -/
def
...
/-- Trait implementation: [gf2_algebra::gray::gray_code_iter::{core::ops::function::FnOnce<(u128), (usize, i8)> for gf2_algebra::gray::gray_code_iter::closure}]
    Source: 'crates/gf2-algebra/src/gray.rs', lines 139:23-148:5 -/
@[reducible]
...
/-- Trait implementation: [gf2_algebra::gray::gray_code_iter::{core::ops::function::FnMut<(u128), (usize, i8)> for gf2_algebra::gray::gray_code_iter::closure}]
    Source: 'crates/gf2-algebra/src/gray.rs', lines 139:23-148:5 -/
@[reducible]
...
/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop body 0:
    ...
    Visibility: public -/
@[rust_loop_body]
def permanent.ryser_fp3.permanent_ryser_fp3_loop0.body
  (n : Std.Usize) (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (i : Std.Usize) :
  Result (ControlFlow ((alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) × Std.Usize)
    (alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)))
  := do
  if i < n
  then
    let f ← gf2_core.gfp.Fp.new 3#u64 0#u64
    let col_sum1 ← alloc.vec.Vec.push col_sum f
    let i1 ← i + 1#usize
    ok (cont (col_sum1, i1))
  else ok (done col_sum)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop 0:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 107:8-110:9
    Visibility: public -/
@[rust_loop]
def permanent.ryser_fp3.permanent_ryser_fp3_loop0
  (n : Std.Usize) (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (i : Std.Usize) :
  Result (alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  := do
  loop
    (fun (col_sum1, i1) => permanent.ryser_fp3.permanent_ryser_fp3_loop0.body n
      col_sum1 i1)
    (col_sum, i)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop body 2:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 136:12-139:13
    Visibility: public -/
@[rust_loop_body]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop0.body
  (matrix : Slice (gf2_core.gfp.Fp 3#u64)) (n : Std.Usize) (flip : Std.Usize)
  (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) (i : Std.Usize) :
  Result (ControlFlow ((alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) × Std.Usize)
    (alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)))
  := do
  if i < n
  then
    let f ←
      alloc.vec.Vec.index (core.slice.index.SliceIndexUsizeSlice
        (gf2_core.gfp.Fp 3#u64)) col_sum i
    let i1 ← i * n
    let i2 ← i1 + flip
    let f1 ← Slice.index_usize matrix i2
    let f2 ← gf2_core.gfp.Fp.Insts.CoreOpsArithAddFpFp.add f f1
    let (_, index_mut_back) ←
      alloc.vec.Vec.index_mut (core.slice.index.SliceIndexUsizeSlice
        (gf2_core.gfp.Fp 3#u64)) col_sum i
    let i3 ← i + 1#usize
    let col_sum1 := index_mut_back f2
    ok (cont (col_sum1, i3))
  else ok (done col_sum)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop 2:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 136:12-139:13
    Visibility: public -/
@[rust_loop]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop0
  (matrix : Slice (gf2_core.gfp.Fp 3#u64)) (n : Std.Usize)
  (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) (flip : Std.Usize)
  (i : Std.Usize) :
  Result (alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  := do
  loop
    (fun (col_sum1, i1) =>
      permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop0.body matrix n flip
      col_sum1 i1)
    (col_sum, i)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop body 3:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 153:8-156:9
    Visibility: public -/
@[rust_loop_body]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop1.body
  (n : Std.Usize) (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (term : gf2_core.gfp.Fp 3#u64) (i : Std.Usize) :
  Result (ControlFlow ((gf2_core.gfp.Fp 3#u64) × Std.Usize) (gf2_core.gfp.Fp
    3#u64))
  := do
  if i < n
  then
    let f ←
      alloc.vec.Vec.index (core.slice.index.SliceIndexUsizeSlice
        (gf2_core.gfp.Fp 3#u64)) col_sum i
    let term1 ← gf2_core.gfp.Fp.Insts.CoreOpsArithMulFpFp.mul term f
    let i1 ← i + 1#usize
    ok (cont (term1, i1))
  else ok (done term)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop 3:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 153:8-156:9
    Visibility: public -/
@[rust_loop]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop1
  (n : Std.Usize) (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (term : gf2_core.gfp.Fp 3#u64) (i : Std.Usize) :
  Result (gf2_core.gfp.Fp 3#u64)
  := do
  loop
    (fun (term1, i1) =>
      permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop1.body n col_sum term1
      i1)
    (term, i)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop body 4:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 143:12-146:13
    Visibility: public -/
@[rust_loop_body]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop2.body
  (matrix : Slice (gf2_core.gfp.Fp 3#u64)) (n : Std.Usize) (flip : Std.Usize)
  (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) (i : Std.Usize) :
  Result (ControlFlow ((alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) × Std.Usize)
    (alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)))
  ...
  then
    ...
    let i2 ← i1 + flip
    let f1 ← Slice.index_usize matrix i2
    let f2 ← gf2_core.gfp.Fp.Insts.CoreOpsArithSubFpFp.sub f f1
    let (_, index_mut_back) ←
      alloc.vec.Vec.index_mut (core.slice.index.SliceIndexUsizeSlice
        (gf2_core.gfp.Fp 3#u64)) col_sum i
    let i3 ← i + 1#usize
...
/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop 4:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 143:12-146:13
    Visibility: public -/
@[rust_loop]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop2
  (matrix : Slice (gf2_core.gfp.Fp 3#u64)) (n : Std.Usize)
  (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) (flip : Std.Usize)
  (i : Std.Usize) :
  Result (alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  ...
  loop
    (fun (col_sum1, i1) =>
      permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop2.body matrix n flip
      col_sum1 i1)
    (col_sum, i)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop body 5:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 153:8-156:9
    Visibility: public -/
@[rust_loop_body]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop3.body
  (n : Std.Usize) (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (term : gf2_core.gfp.Fp 3#u64) (i : Std.Usize) :
  Result (ControlFlow ((gf2_core.gfp.Fp 3#u64) × Std.Usize) (gf2_core.gfp.Fp
    3#u64))
...
/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop 5:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 153:8-156:9
    Visibility: public -/
@[rust_loop]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop3
  (n : Std.Usize) (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (term : gf2_core.gfp.Fp 3#u64) (i : Std.Usize) :
  Result (gf2_core.gfp.Fp 3#u64)
  := do
  loop
    (fun (term1, i1) =>
      permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop3.body n col_sum term1
      i1)
    (term, i)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop body 1:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 122:4-166:5
    Visibility: public -/
@[rust_loop_body]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1.body
  (matrix : Slice (gf2_core.gfp.Fp 3#u64)) (n : Std.Usize) (upper : Std.U128)
  (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (total : gf2_core.gfp.Fp 3#u64) (subset_size : Std.Usize) (k : Std.U128) :
  Result (ControlFlow ((alloc.vec.Vec (gf2_core.gfp.Fp 3#u64)) ×
    (gf2_core.gfp.Fp 3#u64) × Std.Usize × Std.U128) (gf2_core.gfp.Fp 3#u64))
  := do
  if k < upper
  then
    let i ← core.num.U128.trailing_zeros k
    let flip ← lift (UScalar.cast .Usize i)
    let i1 ← k >>> 1#i32
    let g_k ← lift (k ^^^ i1)
    let i2 ← g_k >>> flip
    let i3 ← lift (i2 &&& 1#u128)
    let parity ← if i3 = 1#u128
                 then ok 1#i8
                 else ok (-1)#i8
    if parity = 1#i8
    then
      let subset_size1 ← subset_size + 1#usize
      let col_sum1 ←
        permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop0 matrix n col_sum
          flip 0#usize
      let term ← gf2_core.gfp.Fp.new 3#u64 1#u64
      let term1 ←
        permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop1 n col_sum1 term
          0#usize
      let i4 ← subset_size1 % 2#usize
      let total1 ←
        if i4 = 1#usize
        then gf2_core.gfp.Fp.Insts.CoreOpsArithSubFpFp.sub total term1
        else gf2_core.gfp.Fp.Insts.CoreOpsArithAddFpFp.add total term1
      let k1 ← k + 1#u128
      ok (cont (col_sum1, total1, subset_size1, k1))
    else
      let subset_size1 ← subset_size - 1#usize
      let col_sum1 ←
        permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop2 matrix n col_sum
          flip 0#usize
      let term ← gf2_core.gfp.Fp.new 3#u64 1#u64
      let term1 ←
        permanent.ryser_fp3.permanent_ryser_fp3_loop1_loop3 n col_sum1 term
          0#usize
      let i4 ← subset_size1 % 2#usize
      let total1 ←
        if i4 = 1#usize
...
/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]: loop 1:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 122:4-166:5
    Visibility: public -/
@[rust_loop]
def permanent.ryser_fp3.permanent_ryser_fp3_loop1
  (matrix : Slice (gf2_core.gfp.Fp 3#u64)) (n : Std.Usize)
  (col_sum : alloc.vec.Vec (gf2_core.gfp.Fp 3#u64))
  (total : gf2_core.gfp.Fp 3#u64) (subset_size : Std.Usize) (upper : Std.U128)
  (k : Std.U128) :
  Result (gf2_core.gfp.Fp 3#u64)
  := do
  loop
    (fun (col_sum1, total1, subset_size1, k1) =>
      permanent.ryser_fp3.permanent_ryser_fp3_loop1.body matrix n upper
      col_sum1 total1 subset_size1 k1)
    (col_sum, total, subset_size, k)

/-- [gf2_algebra::permanent::ryser_fp3::permanent_ryser_fp3]:
    Source: 'crates/gf2-algebra/src/permanent/ryser_fp3.rs', lines 79:0-173:1
    Visibility: public -/
  ...
  then
    ...
    then
      ...
      then gf2_core.gfp.Fp.new 3#u64 1#u64
        ...
        let col_sum := alloc.vec.Vec.with_capacity (gf2_core.gfp.Fp 3#u64) n
        let col_sum1 ←
          permanent.ryser_fp3.permanent_ryser_fp3_loop0 n col_sum 0#usize
        let total ← gf2_core.gfp.Fp.new 3#u64 0#u64
        let upper ← 1#u128 <<< n
        let total1 ←
          permanent.ryser_fp3.permanent_ryser_fp3_loop1 matrix n col_sum1 total
            0#usize upper 1#u128
        let i ← n % 2#usize
        if i = 1#usize
        then gf2_core.gfp.Fp.Insts.CoreOpsArithNegFp.neg total1
        else ok total1
    else
      let i := Slice.len matrix
      let a ← core.fmt.rt.Argument.new_display Usize.Insts.CoreFmtDisplay i
      let a1 ←
        core.fmt.rt.Argument.new_display Usize.Insts.CoreFmtDisplay right_val
      let a2 ← core.fmt.rt.Argument.new_display Usize.Insts.CoreFmtDisplay n
      let _ ←
        core.fmt.Arguments.new
          (Array.make 74#usize [
            35#u8, 112#u8, 101#u8, 114#u8, 109#u8, 97#u8, 110#u8, 101#u8,
            110#u8, 116#u8, 95#u8, 114#u8, 121#u8, 115#u8, 101#u8, 114#u8,
            95#u8, 102#u8, 112#u8, 51#u8, 58#u8, 32#u8, 109#u8, 97#u8, 116#u8,
            114#u8, 105#u8, 120#u8, 46#u8, 108#u8, 101#u8, 110#u8, 40#u8,
            41#u8, 32#u8, 40#u8, 192#u8, 20#u8, 41#u8, 32#u8, 109#u8, 117#u8,
            115#u8, 116#u8, 32#u8, 101#u8, 113#u8, 117#u8, 97#u8, 108#u8,
            32#u8, 110#u8, 32#u8, 42#u8, 32#u8, 110#u8, 32#u8, 40#u8, 192#u8,
            12#u8, 41#u8, 32#u8, 119#u8, 104#u8, 101#u8, 114#u8, 101#u8, 32#u8,
            110#u8, 32#u8, 61#u8, 32#u8, 192#u8, 0#u8
    ...
    let _ ←
      core.fmt.Arguments.new
        (Array.make 87#usize [
          25#u8, 112#u8, 101#u8, 114#u8, 109#u8, 97#u8, 110#u8, 101#u8, 110#u8,
          116#u8, 95#u8, 114#u8, 121#u8, 115#u8, 101#u8, 114#u8, 95#u8, 102#u8,
          112#u8, 51#u8, 58#u8, 32#u8, 110#u8, 32#u8, 61#u8, 32#u8, 192#u8,
          58#u8, 32#u8, 101#u8, 120#u8, 99#u8, 101#u8, 101#u8, 100#u8, 115#u8,
          32#u8, 116#u8, 104#u8, 101#u8, 32#u8, 115#u8, 105#u8, 110#u8, 103#u8,
          108#u8, 101#u8, 45#u8, 117#u8, 54#u8, 52#u8, 32#u8, 71#u8, 114#u8,
          97#u8, 121#u8, 45#u8, 99#u8, 111#u8, 100#u8, 101#u8, 32#u8, 114#u8,
          101#u8, 103#u8, 105#u8, 115#u8, 116#u8, 101#u8, 114#u8, 39#u8,
          115#u8, 32#u8, 110#u8, 32#u8, 60#u8, 61#u8, 32#u8, 54#u8, 51#u8,
          32#u8, 98#u8, 111#u8, 117#u8, 110#u8, 100#u8, 0#u8
          ]) (Array.make 1#usize [ a ])
    fail panic
