...
`target/`, the agent worktree roots and `.jit/gate-runs/` are build and tooling
noise; `breakdown.json` is a frozen copy of issue descriptions rather than live
prose, for the reasons its
