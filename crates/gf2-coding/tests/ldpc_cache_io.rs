...
#[test]
#[ignore = "Slow: requires DVB-T2 preprocessing (~2-3 seconds)"]
...
fn test_cache_load_is_fast() {
    ...
    // Should be much faster than 2-3 seconds
    assert!(load_time.as_millis() < 100, "Load should be <100ms");
    assert!(create_time.as_micros() < 100, "Create should be <100μs");
}

#[test]
#[ignore = "Very slow: requires all 12 DVB-T2 configs preprocessing (~30-60 seconds)"]
fn test_precompute_and_save_dvb_t2() {
    ...
    for entry in files {
        ...
        assert!(size_kb > 100 && size_kb < 5000, 
                "File size should be 100KB-5MB, got {}KB", size_kb);
    }
}
...
fn test_load_dvb_t2_cache() {
    ...
    let configs = [
        (gf2_coding::ldpc::dvb_t2::FrameSize::Short, CodeRate::Rate1_2),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Short, CodeRate::Rate3_5),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Short, CodeRate::Rate2_3),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Short, CodeRate::Rate3_4),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Short, CodeRate::Rate4_5),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Short, CodeRate::Rate5_6),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Normal, CodeRate::Rate1_2),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Normal, CodeRate::Rate3_5),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Normal, CodeRate::Rate2_3),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Normal, CodeRate::Rate3_4),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Normal, CodeRate::Rate4_5),
        (gf2_coding::ldpc::dvb_t2::FrameSize::Normal, CodeRate::Rate5_6),
    ];
...
fn test_empty_directory_loads_empty_cache() {
    ...
    assert_eq!(stats.entries, 0, "Empty directory should create empty cache");
}
