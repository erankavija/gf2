...
impl Header {
    ...
    pub fn read_from<R: Read>(reader: &mut R) -> Result<Self> {
        ...
        let type_tag = TypeTag::from_u8(type_byte[0])
            .ok_or(IoError::UnknownType(type_byte[0]))?;
...
mod tests {
    ...
    fn test_header_all_type_tags() {
        for type_tag in [TypeTag::BitVec, TypeTag::BitMatrix, 
                         TypeTag::SpBitMatrix, TypeTag::SpBitMatrixDual] {
