...
- The only exception to SSOT is if legacy code is being refactored. There has to be a clear plan to eliminate the duplication in a future issue, and the new code must be written in a way that makes it easy to refactor later.
