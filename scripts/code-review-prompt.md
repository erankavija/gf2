...
**Commit quality**: commits shall be logically organized, and a single commit shall contain work from single issue. Work order may be non-linear and the review shall be based on the local state of the repository. Commit order is not a reason for review failure.
